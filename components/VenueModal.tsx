...
import { MapPin, Navigation, Calendar, Clock, Utensils, X, Plus } from 'lucide-react';
...
export default function VenueModal({ venue, onClose }: VenueModalProps) {
  ...
  return (
    <>
      <div className="absolute right-6 top-6 bottom-6 w-96 bg-[#111]/95 backdrop-blur-xl border border-gray-800 rounded-2xl shadow-2xl flex flex-col z-[1001] animate-in slide-in-from-right-8 duration-300">
        
        {/* Header */}
        <div className="p-6 border-b border-gray-800 relative">
          <button 
            onClick={onClose}
            className="absolute top-4 right-4 p-2 bg-gray-900 hover:bg-gray-800 rounded-full text-gray-400 hover:text-white transition-colors"
          >
            <X size={16} />
          </button>
          
          <h2 className="text-xl font-semibold text-white pr-10">{venue.name}</h2>
        ...
        <div className="p-6 flex-1 overflow-y-auto">
          {activeWedding ? (
            <div className="space-y-6">
              ...
              <div className="text-center space-y-2 py-4 bg-gray-900/50 rounded-xl border border-gray-800">
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3 text-gray-300 bg-gray-900/30 p-3 rounded-lg border border-gray-800/50">
            ...
            <div className="flex flex-col items-center justify-center h-full text-center space-y-4 py-10">
              ...
              <div>
                <h3 className="text-lg font-medium text-gray-300">No Active Weddings</h3>
